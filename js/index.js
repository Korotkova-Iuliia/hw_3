...
//     const nameObjects = Object.values(product)[0];
...
//     if (nameObjects === productName) {
//       console.log(Object.values(product)[1]);
//       return Object.values(product)[1];
//     }
//   }
//   console.log(null);
//   return null;
...
// };
// // Change code below this line
// // переменные ниже деструкторизованы в коде выше
...
// console.log(add(2, 5, 35, 56, 12, 24, 7, 80, 3));
// add(12, 4, 11, 48);
...
//     if (arrayNew.includes(argsNew[i])) {
//       matches.push(argsNew[i]);
//       continue;
//     }
//     console.log(argsNew.includes(argsNew[i]));
//   }
//   console.log(matches);
//   return matches;
// }
...
//   },
//   updateBook(bookNameOld, bookNameChanged) {
//     return `Updating book ${bookNameOld} to ${bookNameChanged}`;
//   },
// };
